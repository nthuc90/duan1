        ...
        <div class="header-cart flex-col-l p-l-65 p-r-25">
            ...
            <div class="header-cart-content flex-w js-pscroll">
                ...
                @foreach($orders as $item)
                    <li class="header-cart-item flex-w flex-t m-b-12">
                            <a href="{{getClientUrl('delete-shop', ['id'=>$item->id])}}">
                                <div class="how-itemcart1">
								<img src="{{getClientUrl($item->getProductImage())}}" alt="IMG"></div>
                            </a>
                        ...
                        <div class="header-cart-item-txt p-t-8">
                            ...
                            <span class="header-cart-item-info">
                            {{$item->amount_of}} x ${{$item->getProductPrice()}}	
                            <?php
		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    ...
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".{{$item->cate_name}}">
                        {{$item->cate_name}}
                    </button>
                    @endforeach
				</div>
			...
			@foreach($products as $item)
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{$item->getCategoryName()}}">
                    <!-- Block2 -->
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="{{getClientUrl($item->image)}}" alt="IMG-PRODUCT">

                            <a href="{{getClientUrl('shop-detail', ['id'=>$item->id])}}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View
							</a>
                        </div>
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                <a href="{{getClientUrl('shop-detail', ['id'=>$item->id])}}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                {{$item->name}}
								</a>
