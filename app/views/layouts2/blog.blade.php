			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="p-b-63">
							<a href="{{getClientUrl('blog-detail', ['id'=>$item->id])}}" class="hov-img0 how-pos5-parent">
								<img src="{{getClientUrl($item->image)}}" alt="IMG-BLOG"  header="550" >
							...
							<div class="p-t-32">
								<h4 class="p-b-15">
									<a href="{{getClientUrl('blog-detail', ['id'=>$item->id])}}" class="ltext-108 cl2 hov-cl1 trans-04">
									{{$item->name}}
									</a>
								</h4>
