                ...
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        ...
                        if(isset($_SESSION['auth']['name']) == "name"){
                            ...
                            <?php
                            echo "<a href='account' style='color: #ddd;padding: 0 25px 0 0px;' class='flex-c-m trans-04 p-lr-25'>".($_SESSION['auth']['name']."</a>");
            ...
            <div class="header-cart-content flex-w js-pscroll">
				...
				?>	                  
						...
						<li class="header-cart-item flex-w flex-t m-b-12">
							<a href="<?php echo "delete-index?id={$sp['id']}" ?>">
    ...
    <section class="section-slide">
        <div class="wrap-slick1">
            ...
            @foreach($slides as $item)
                <div class="item-slick1" style="background-image: url('{{getClientUrl($item->image)}}')">
