			...
			<div class="row">
				...
				<div class="col-md-10 col-lg-8">
					<div class="intro">
						...
						<h2><b>Đỗ Việt Thắng</b></h2>
						<h6>Cập nhật hồ sơ</h6>
						<ul class="information margin-tb-30">
						Họ tên: <input type="text" name="ten"><br><br>
							Ảnh:  <input type="file" name="upload"><br><br>
							Email: <input type="text" name="email"><br><br>
							SĐT: <input type="text" name="sdt"><br><br>
							Giới tính: <input type="radio" value="0">Nam
								   <input type="radio" value="1">Nữ
								   <input type="radio" value="2">Khác<br><br>
							Ngày sinh:
...
</html><?php /**PATH C:\xampp\htdocs\Duan1\app\views/layouts2/account.blade.php ENDPATH**/ ?>