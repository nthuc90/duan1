				...
				<div class="m-l-25 m-r--38 m-lr-0-xl">
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<td>
							<a  href="<?php echo e(getClientUrl('order-detail-delete', ['id'=>$item->id])); ?>" class="btn btn-sm btn-danger">hủy đơn</a>
							</td>
...
</html><?php /**PATH C:\xampp\htdocs\test\shop-thoiTrang\app\views/layouts2/orderDetail.blade.php ENDPATH**/ ?>