        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <?php if(isset($err['price'])): ?>
                         <p style="color: red"><?php echo e($err['price']); ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if(isset($err['number'])): ?>
                         <p style="color: red"><?php echo e($err['number']); ?></p>
                    <?php endif; ?>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <?php if(isset($err['more_information'])): ?>
                         <p style="color: red"><?php echo e($err['more_information']); ?></p>
                    <?php endif; ?>
                </div>                
                <div class="form-group">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test\shop-thoiTrang\app\views/admin/product/add.blade.php ENDPATH**/ ?>