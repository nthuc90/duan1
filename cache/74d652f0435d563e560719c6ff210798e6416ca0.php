...
<!doctype html>
  ...
  <div class="content-header">
    ...
    <table class="table table-striped">
        ...
        <th class="font-weight-normal" ><?php echo e($item->getProductName()); ?></th>
        <th scope="row"><?php echo e($item->content); ?></th>
        <th scope="row"><span class="rating" data-default-rating="<?php echo e($item->star); ?>" disabled></span></th>
        </tr>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test\shop-thoiTrang\app\views/admin/comment/index-comment.blade.php ENDPATH**/ ?>